...
public class M11Q12 {
	...
	public void test1(){
		try{
            ...
            n2.previous = n1;
            n3.previous = n2;
			int res = M11Q12Stu.minimum(n1);
			assertEquals(str + "la valeur du minimum devrait être 1 mais est de "+res, 1, res);
	...
	public void test2(){
		try{
            ...
            n3.previous = n2;
			int res = M11Q12Stu.minimum(n1);
			assertEquals(str + "la valeur du minimum devrait être 2 mais est de "+res, 2, res);
	...
	public void test3(){
		try{
            ...
            n6.previous = n5;
            int res = M11Q12Stu.minimum(n1);
			assertEquals(str + "la valeur du minimum devrait être 0 mais est de "+res, 0, res);
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M11Q12.class);
