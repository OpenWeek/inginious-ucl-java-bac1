...
public class M11Q11 {
	...
	public void test2(){
		try{
            ...
            n3.previous = n2;
			int res = M11Q11Stu.maximum(n1);
			assertEquals(str + "la valeur du maximum n'est pas correcte", 5, res);
	...
	public void test3(){
		try{
            ...
            n6.previous = n5;
            int res = M11Q11Stu.maximum(n1);
			assertEquals(str + "la valeur du maximum n'est pas correcte", 123, res);
	...
	public void test4(){
		try{
            ...
            n3.previous = n2;
			int res = M11Q11Stu.maximum(n1);
			assertEquals(str + "la valeur du maximum n'est pas correcte", 42, res);
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M11Q11.class);
