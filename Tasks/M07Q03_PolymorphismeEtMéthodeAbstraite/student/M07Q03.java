...
public class M07Q03 {
	...
	public static boolean applyManger(Object o, M07Q03Stu.PanierDeNourriture p){
	...
	public void testChevre(){
		try{
			...
			//
        	M07Q03Stu mission = new M07Q03Stu();
            Class<?> enclosingClass = Class.forName("student.M07Q03Stu");
        	Object enclosingInstance = enclosingClass.newInstance();

        	Class<?> innerClass = Class.forName("student.M07Q03Stu$Chevre");
        	...
        	//	Lance les tests
        	//
    		M07Q03Stu.PanierDeNourriture p = mission.new PanierDeNourriture(2,2);
	...
	public void testOurs(){
		try{
        	...
        	Class<?> innerClass = Class.forName("student.M07Q03Stu$Ours");
        	Constructor<?> ctor = innerClass.getDeclaredConstructor(enclosingClass);
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M07Q03.class);
