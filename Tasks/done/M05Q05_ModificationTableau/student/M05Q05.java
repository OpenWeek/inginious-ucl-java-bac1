...
public class M05Q05 {
	...
	try{
            ...
            try{
            	M05Q05Stu.shiftRightOne(stuShiftRightOne);
	...
	public void testQ2(){
		...
		try{
            ...
            try{
            	M05Q05Stu.shiftRight(stuShiftRight, shift);
            }catch (AssertionError e) {
		fail("Question 2 :\nVous n'utilisez pas correctement assert.");	
 	    }
            ...
            boolean err=false;
            try {
            	M05Q05Stu.shiftRight(null, shift);
                err=true;
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M05Q05.class);
