...
public class M06Q04 {
	...
	public void test1(){
		try{
           String prof1 = "prof" + (int)(Math.random() * 10 / 1);
            ...
            M06Q04Stu a = new M06Q04Stu(prof1, code1, credit1);
            M06Q04Stu b = new M06Q04Stu(prof1, code1, credit1);
	...
	public void test2(){
		try{
           String prof1 = "prof" + (int)(Math.random() * 10 / 1);
            ...
            M06Q04Stu b = new M06Q04Stu(prof2, code2, credit2);
		...
		try{
           ...
           String prof2 = "pr" + (int)(Math.random() * 10 / 1);
    		String code1 = "code" + (int)(Math.random() * 10 / 1);
   		    int credit1 = (int)(Math.random() * 10 / 1);
            M06Q04Stu a = new M06Q04Stu(prof1, code1, credit1);
            M06Q04Stu b = new M06Q04Stu(prof2, code1, credit1);
		...
		try{
           String prof1 = "prof" + (int)(Math.random() * 10 / 1);
            ...
            String code2 = "co" + (int)(Math.random() * 10 / 1);
   		    int credit1 = (int)(Math.random() * 10 / 1);
            M06Q04Stu a = new M06Q04Stu(prof1, code1, credit1);
            M06Q04Stu b = new M06Q04Stu(prof1, code2, credit1);
	...
	public void test5(){
		try{
           String prof1 = "prof" + (int)(Math.random() * 10 / 1);
            ...
            int credit2 = (int)(Math.random() * 10 / 1) + 10;
            M06Q04Stu a = new M06Q04Stu(prof1, code1, credit1);
            M06Q04Stu b = new M06Q04Stu(prof1, code1, credit2);
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M06Q04.class);
