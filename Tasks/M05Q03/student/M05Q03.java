...
public class M05Q03 {
	...
	public void test(){
		try{
            ...
            int solStu[][]=M05Q03Stu.multiplication(l,m);
            int sol[][]=mul(l,m);
	...
	public void testProgDef(){ // vérification de l'utilisation de la programation défensive
		try{
           ...
           try{
            	M05Q03Stu.multiplication(l,null);
                err=true;
            } catch (AssertionError e) {
            	// Pour vérifier qu'une Assertion a bien été lancée
            } catch (NullPointerException e) {
            ...
            try{
            	M05Q03Stu.multiplication(null,m);
                err=true;
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M05Q03.class);
