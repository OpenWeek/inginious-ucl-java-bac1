...
public class M05Q06 {
	...
	@Test
	public void testM05Q06(){
		try{
        	assertNull("n'oubliez pas ou le cas ou le parametre est null",M05Q06Stu.sum(null));
            int[] a = {1,2,3,4,5};
            int[] b = M05Q06Stu.sum(a);
            int[] c = {1,3,6,10,15};
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M05Q06.class);
