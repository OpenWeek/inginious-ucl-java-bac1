...
public class M07Q01 {
	...
	public void testLapin(){
		try{        
        	M07Q01Stu mission = new M07Q01Stu();
            Class<?> enclosingClass = Class.forName("student.M07Q01Stu");
        	Object enclosingInstance = enclosingClass.newInstance();

        	Class<?> innerClass = Class.forName("student.M07Q01Stu$Lapin");
        	Constructor<?> ctor = innerClass.getDeclaredConstructor(enclosingClass);

        	Object lapin = ctor.newInstance(enclosingInstance);
            if (!(lapin instanceof M07Q01Stu.Animal))
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M07Q01.class);
