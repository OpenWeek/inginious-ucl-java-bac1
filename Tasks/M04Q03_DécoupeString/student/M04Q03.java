...
public class M04Q03 {
	...
	@Test
	public void testM04Q03(){
    	try{
    		M04Q03Stu.cut("Hello, world! It's a nice day to make some Java programming!",' ',"test1.txt");
        ...
        @Test
        public void testM04Q032(){
    	try{
    		M04Q03Stu.cut("hello",'.',"test2.txt");
	...
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(M04Q03.class);
