...
public class M5QInversion {
    ...
    /*
    * @post: test le code de l'étudiant pour un tableau d'une longueur len
    */
    private void testComp(int len){
        ...
        assertTrue("Question 1 : \n Le tableau est mal inverser, votre solution: "+ Arrays.toString(stuTabInv)+" pour ce tableau en argument "+Arrays.toString(tab),Arrays.equals(tabInv,stuTabInv));
	...
	public void test(){
		try{
            ...
            testComp(5); // test la fonction de l'étudiant 
            			 // pour un tableau de longueur impaire
            testComp(6); // et paire
